...
try {
    ...
    foreach ($file in $allFiles) {
        ...
        $content = $content -replace 'https://github\.com/shumingyang-opencode/opencode-lazy-packs/-/issues', 'https://github.com/shumingyang-opencode/opencode-lazy-packs/issues'
