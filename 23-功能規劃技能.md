...
```bash
mkdir -p ~/.agents/skills/project-plan-feature/scripts
mkdir -p ~/.agents/skills/project-plan-feature/references
```

### 步驟二：建立 SKILL.md

建立 `~/.agents/skills/project-plan-feature/SKILL.md`：
...
建立 `~/.agents/skills/project-plan-feature/scripts/init_plan.py`。
...
cp scripts/init_plan.py \
  ~/.agents/skills/project-plan-feature/scripts/init_plan.py
```

### 步驟四：建立參考文件

建立 `~/.agents/skills/project-plan-feature/references/plan-writing-guide.md`：
...
建立 `~/.agents/skills/project-plan-feature/references/pre-check-guide.md`：
...
```bash
# 確認 skill 可被辨識
ls ~/.agents/skills/project-plan-feature/SKILL.md
ls ~/.agents/skills/project-plan-feature/scripts/init_plan.py
ls ~/.agents/skills/project-plan-feature/references/

# 測試 init_plan.py 可執行
python ~/.agents/skills/project-plan-feature/scripts/init_plan.py --help
```
...
| `init_plan.py` 找不到 | 從 repo 重新複製 `cp -r skills/23-project-plan-feature/* ~/.agents/skills/project-plan-feature/` |
...
- init_plan.py：✅ 已複製（~/.agents/skills/.../scripts/）
...
1. 選擇安裝層級：
   ...
   - **專案（僅當前專案）**：`.agents/skills/project-plan-feature/`
...
- 專案：`.agents/skills/project-plan-feature/SKILL.md`
