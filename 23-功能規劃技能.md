...
1. 將本技能放入 `.trae/skills/project-plan-feature/` 目錄：
   ```bash
   mkdir -p .trae/skills/project-plan-feature/
   ```
2. 從本 repo 的 `skills/23-project-plan-feature/SKILL.md` 複製內容到 `.trae/skills/project-plan-feature/SKILL.md`
3. 重新載入 Trae（Cmd+R / Ctrl+R）
4. 對 Trae 說「規劃新功能」，確認可載入

### 在 Trae 上更新

替換 `.trae/skills/project-plan-feature/SKILL.md` 的內容即可。
