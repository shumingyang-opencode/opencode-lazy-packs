...
| `init_plan.py` 找不到 | 確認 `~/.config/opencode/skills/project-plan-feature/scripts/init_plan.py` 存在，或從 repo 重新複製 |
| 產生的檔案在哪？ | 在專案的 `docs/<NN>_<name>-計劃中/` 目錄下 |
| 如何切換階段？ | `git mv docs/<NN>_<name>-計劃中 docs/<NN>_<name>-分析中` |
